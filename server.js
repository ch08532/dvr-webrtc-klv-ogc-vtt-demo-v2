...
import { createTargetLogRouter } from "./src/routes/targetLog.js";
import { createWebrtcRouter } from "./src/routes/webrtc.js";
...
app.use(createUploadsRouter({
  ...
  MAX_UPLOAD_BYTES,
  activeResumableUploads,
  resumableUploadPaths,
  listLocalServerVideos,
  copyLocalServerVideo,
  currentSourceState,
  sources,
  getSourceRuntime,
  ...
  probeInputWithFfprobe,
  log,
  serializeError
}));
// ---------- API: source inventory and state ----------
app.use(createSourcesRouter({
  sources,
  sourceStates,
  getSourceRuntime,
  currentSourceState,
